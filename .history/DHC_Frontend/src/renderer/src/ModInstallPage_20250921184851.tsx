...
function ModInstallPage(): React.JSX.Element{
  ...
  return(
    <Layout style={{height:'100%',width:'100%', display:'flex',flexDirection:'column'}}>
      ...
      <Layout style={{backgroundColor:'rgb(101, 111, 212)', height:'100%',width:'100%',}}>
        <Layout style={{alignItems:'center', backgroundColor:'rgb(213, 26, 26)', height:'30%',width:'80%',alignItems:'center'}} >
