...
function ModInstallPage(): React.JSX.Element{
  ...
  return(
    <Layout style={{height:'100%',width:"100%", display:'flex',flexDirection:'column'}}>
      <Layout style={{height:200,display:'flex',justifyContent:'center',alignItems:'center'}}>
        <Card style={{background: 'white', display:'flex', justifyContent:'center', alignItems:'center', padding: 0, width: 'fit-content'}}>
