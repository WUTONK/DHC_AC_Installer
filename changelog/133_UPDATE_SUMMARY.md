...
**本次大更新**: 新增欢迎页面（WelcomePage）包含一键安装引导、磁盘可视化、智能盘符推荐；添加地区切换功能（自动检测+手动切换中国/美国）；资源管理添加一键清除功能；修复Tag和Collapse组件问题

**上一次大更新**: `1773852` - 更新decompression.ditSet 按照优先级：1. SSD > HDD  2. 固定设备 > 可拔插设备  3. 剩余空间大小 处理推荐设备顺序，添加infoget.getDiskInfo():使用powershell来获取磁盘信息
