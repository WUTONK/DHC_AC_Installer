...
// 设计参照存档：git 提交 2666de0 上的 installations_test.go（与本仓库当前 handler 测试并行保留，不参与默认 go test）。
// 带 //go:build ignore。查看原始提交：git show 2666de0:DHC_Backend/test/unitTest/handler/installations_test.go
