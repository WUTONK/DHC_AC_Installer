...
// 设计参照存档：git 提交 2666de0 上的 DHC_Backend/handler/installations.go（HEAD~1，具体以你仓库 git log 为准）。
// 带 //go:build ignore，不参与编译，仅供对照阅读，避免与当前 installations.go 冲突。
// 查看原始提交：git show 2666de0:DHC_Backend/handler/installations.go
